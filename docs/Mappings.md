...
| **Output Port** | 0xC0080000 | - | Write byte to stdout buffer |
| **Interrupt Controller** | 0xC00C0000:0xC00C00FF | Read code of the active interrupt | - |
| **Power Manager** | 0xC00C0000 | Exit emulator | Exit emulator |
